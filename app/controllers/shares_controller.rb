...
before_filter :already_shared, :only => [:new]
  ...
  if current_user.nil?
	...
	flash[:success] = "Great! To join this club, please sign in below."
  ...
  @tweet_text = 'I just joined the ' + @project.brand_name + ' fan club on Snowball. You can too. '
